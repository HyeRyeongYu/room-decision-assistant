...
Composition with CustomItem (1..\*) <br>
...
### Relationship (타 클래스와의 관계)
Association with Checklist (1..\*) <br>
...
- 따라서, CompareResult Class와 Checklist Class는 다중 연관관계(Association with 1..\*)로 연결한다.
<br>
...
- Room Checkmate 시스템은 해당 클래스를 비교 결과를 기반으로 사용자에게 가장 최적의 추천 매물을 제공한다.
<br>
